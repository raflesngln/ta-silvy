...
<div class="col10 scrumb"><a href="index.php">Home</a> &raquo; <?php echo $nm_kategori;?></div>
<div class="batas"></div>
<h1 class="judul">Kategori <?php echo $nm_kategori;?> </h1>
<div class="batas"></div>
...
$query="Select * from produk a
 ...
 where a.id_kategori='$idkategori' GROUP BY b.id_produk";
