...
?>
<div class="col10 scrumb"><a href="index.php">Home</a> &raquo; Tambah Kurir</div>
<div class="batas"></div>

<form action="kurir/simpan_kurir.php" method="post"  enctype="multipart/form-data">

<div class="row" >
<div class="col10" id="box-add">

<h1><i class="fa fa-plus"></i> Tambah kurir</h1>

<div class="input-group">
<div class="col2">Nama kurir</div>
