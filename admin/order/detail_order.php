...
<div class="col8"><h1><?php echo $data['id_order'];?></h1></div>
</div>
...
<div class="col10"><h3 class="text-right">Total Belanja  :<?php echo 'Rp   '.number_format($grandtotal,0,'.','.');?></h3></div>
<div class="col10"><h3 class="text-right">Ongkir  :<?php echo 'Rp   '.number_format($harga_ongkir,0,'.','.');?></h3></div>

<div class="col10" style="border-top:1px #999 solid"><h3 class="text-right">Total Bayar  :<?php echo 'Rp   '.number_format($bayar,0,'.','.');?></h3></div>

<div class="col4">
<?php
if($status_order <=2){
?>
<a href="home.php?page=konfirmasi_order&&id_order=<?php echo $id_order ;?>"><button class="btn-lime btn-block"> <i class="fa fa-check"></i> Konfirmasi Order &raquo;</button></a>
<?php } ?>
</div>
</div>
